...
parser.add_argument('--test_dir',default='/home/dataset/VeRi/pytorch',type=str, help='./test_data')
...
def load_network(network):
    ...
    # network.load_state_dict(torch.load('./pretrain/swin_base_patch4_window7_224.pth')["model"], strict=False)
...
# model_structure = swin(opt.nclasses)
model_structure = swin_for_veri(opt.nclasses,circle=True,pretrain=True)
